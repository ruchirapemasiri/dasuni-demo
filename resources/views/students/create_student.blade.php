...
@section('content')
    ...
    <div class="register-form-div">
        <form class="register-form" method="POST" action="{{ route('students.save_student') }}">
            @csrf
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <textarea class="input" name="student_fname" id="std-name" rows="2">{{ old('student_fname') }}</textarea>
                        @error('student_fname')
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <textarea class="input" name="address" id="address" rows="2">{{ old('address') }}</textarea>
                        @error('address')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <input class="input" text="text" name="branch" id="branch" value="{{ old('branch') }}" />
                        @error('branch')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
